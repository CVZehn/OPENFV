...
void DCMI_DMA_Init(u32 DMA_Memory0BaseAddr,u32 DMA_BufferSize,u32 DMA_MemoryDataSize,u32 DMA_MemoryInc)
{ 
...
{        
	if(DMA_GetFlagStatus(DMA2_Stream0,DMA_FLAG_TCIF1)==SET)//DMA2_Steam1,传输完成标志
	{  
		 DMA_ClearFlag(DMA2_Stream0,DMA_FLAG_TCIF1);//清除传输完成中断
	}    											 
} 
...
void My_DCMI_Init(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_9|GPIO_Pin_8|GPIO_Pin_11;//PC6/7/8/9/11 复用功能输出

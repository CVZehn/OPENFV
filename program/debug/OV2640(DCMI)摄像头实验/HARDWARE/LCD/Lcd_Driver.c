...
void LCD_GPIO_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_9| GPIO_Pin_10| GPIO_Pin_13 | GPIO_Pin_14| GPIO_Pin_15;
...
#if USE_HARDWARE_SPI   
		SPI_WriteByte(SPI2,BLUE>>8);
		SPI_WriteByte(SPI2,BLUE);
#else
		SPIv_WriteData(Color>>8);
		SPIv_WriteData(Color);
#endif 
